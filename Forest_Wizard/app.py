...
def make_post_request(json_body):
    ...
    #api_url = 'https://oai-nonprd-openai-poc-01.openai.azure.com/openai/deployments/BASE-gpt-35-turbo/chat/completions?api-version=2024-02-15-preview&api-key='+api_key

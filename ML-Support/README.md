...
### r_env
```
conda create -n usfs_r_env -c conda-forge r-base r-essentials r rstudio r-shiny -y
```
...
## PyTorch via Anaconda (v2.4, CUDA 12.4)
sudo $(which conda) install pytorch torchvision torchaudio pytorch-cuda=12.4 -c pytorch -c nvidia

## TensorFlow via Anaconda (v2.17, CUDA 12.4)
sudo $(which conda) install tensorflow-gpu -c conda-forge

## Hard Install
+ pip install  --extra-index-url=https://pypi.nvidia.com     cudf-cu12==24.6.*
+ sudo apt remove --auto-remove nvidia-cuda-toolkit
...
+ pip3 install tensorflow==2.14.0 --user
...
## Change Debugging for TensorFlow
import os
os.environ["TF_CPP_MIN_VLOG_LEVEL"] = "2"
# Turn off warnings in TensorFlow = os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'

pip install tf-keras #backwards compatible with Hugging Face
## macOS

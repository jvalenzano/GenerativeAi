...
repos=( git@github.com:christophergarthwood/jbooks.git git@github.com:christophergarthwood/configs.git git@github.com:christophergarthwood/ai_multivariate.git git@github.com:christophergarthwood/ai_computer_vision.git git@github.com:christophergarthwood/ai_basic.git git@github.com:USDAForestService/network_metrics.git git@github.com:USDAForestService/jbooks.git git@code.fs.usda.gov:forest-service/GenerativeAi.git )
repos_names=( my_jbooks my_configs ai_multivariate ai_computer_vision ai_basic usda_network_metrics usda_jbooks GenerativeAi )
